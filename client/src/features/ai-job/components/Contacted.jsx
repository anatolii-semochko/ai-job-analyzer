...
import { fetch as fetchJobs, updateFlags, getFilterOptions } from '../service/jobService'
...
const Contacted = ({ onUpdate }) => {
    ...
    const loadJobs = async () => {
        ...
        try {
            ...
            let filtered = data.filter(j => j.contacted && !j.hidden && !j.refused)
    ...
    return (
        <div>
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 className="mb-0">Contacted ({jobs.length})</h5>
                <TableFilter
                    sortBy={sortBy}
                    sortOrder={sortOrder}
